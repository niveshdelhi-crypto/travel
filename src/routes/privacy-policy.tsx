...
function PrivacyPolicyPage() {
  useDocumentMeta(
    "MarkleTravelBooking Privacy Policy",
    "MarkleTravelBooking data handling posture for concierge bookings, Postgres CRM metadata, telemetry, analytics, cookies, jurisdictions, subprocessors, traveler rights.",
  );

  const sections = [
    {
      heading: "1. Stewardship posture",
      body: "MarkleTravelBooking processes traveler contact data strictly to originate rental assistance engagements. Sensitive payment credentials never transit the anonymous landing funnel—payments route through audited suppliers once advisors formalize confirmations.",
    },
    {
    ...
    },
    {
      ...
      body: "Operational teams define retention ladders per tenant. Default CRM retention aligns with bookkeeping requirements for rental economics—purge tickets open through security@markletravelbooking.com alias once legal holds resolve.",
    },
    {
