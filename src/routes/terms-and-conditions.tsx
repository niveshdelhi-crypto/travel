      ...
      <article className="prose prose-invert prose-headings:text-[#F8FAFC] mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 prose-p:text-[#CBD5F5]/90">
        ...
        <section className="mt-10">
          ...
          <p className="mt-4 text-base leading-relaxed">
            FleetNexus assists with routing premium rental demand to verified partners. We are not the lessor
        ...
        <section className="mt-10">
          ...
          <p className="mt-4 text-base leading-relaxed">
            ...
            /marketplace/*` payloads remain FleetNexus or licensor IP; scraping for model training violates
        ...
        <section className="mt-10">
          ...
          <p className="mt-4 text-base leading-relaxed">
            To the maximum extent permitted by law, FleetNexus disclaims incidental damages arising from ETA
            miscalculations, partner outages, or force-majeure—subject to carve-outs for intentional
            misconduct. Venue defaults to FleetNexus’ corporate domicile unless enterprise contracts steer
            elsewhere.
          </p>
        </section>
      </article>
