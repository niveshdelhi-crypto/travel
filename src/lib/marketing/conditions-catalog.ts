...
export const CONDITION_SECTIONS: ConditionSection[] = [
  {
    ...
    icon: Banknote,
    summary:
      "Deposits are captured by contracted suppliers through certified acquirers. FleetNexus does not monetize interchange on those holds and surfaces only what your advisor confirms.",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Personal travel policies should be verified with brokers; FleetNexus is not selling regulated insurance instruments.",
  ...
  },
  {
    ...
    bullets: [
      "Young-driver fees are contractual pass-through charges; FleetNexus does not pocket margin on them.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "FleetNexus never stores PAN data on public landing surfaces.",
    ],
  },
  {
    id: "idp",
  ...
  },
  {
    ...
    icon: ParkingCircle,
    summary:
      "Facility cost recovery flows through customer-of-record invoices; they are neither optional nor arbitrarily padded by FleetNexus.",
    bullets: [
