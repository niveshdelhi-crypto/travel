...
export const Route = createFileRoute("/cars/$country")({
  head: ({ params }) => {
    ...
    return {
      meta: [
        { title: `Car rental ${name} — Compare deals | FleetNexus` },
        ...
        { property: "og:title", content: `Car rental ${name} | FleetNexus` },
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_320px]">
          <div className="prose-section space-y-12">
            ...
            <Section title="Frequently asked questions">
              ...
              <Faq q="Can I cancel for free?" a="Most rentals on FleetNexus offer free cancellation up to 48 hours before pickup." />
            </Section>
          </div>
